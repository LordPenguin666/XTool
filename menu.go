...
func (c *Config) menu() {
	...
	fmt.Printf("  %v %v\n", green("13) "), blue("启动 Caddy"))
	fmt.Printf("  %v %v\n", green("14) "), blue("重启 Caddy"))
	fmt.Printf("  %v %v\n", green("15) "), blue("关闭 Caddy"))
	fmt.Printf("  %v %v\n", green("16) "), blue("自启动 Caddy"))
	fmt.Printf("  %v %v\n", green("17) "), blue("关闭自启动 Caddy"))
	fmt.Printf("  %v %v\n", green("18) "), blue("卸载 Caddy"))
	fmt.Printf("  %v %v\n", green("19) "), blue("安装 Caddy"))
	fmt.Println()
	fmt.Printf("  %v %v\n", green("21) "), blue("修改 Xray Xtls 端口 (在写了在写了)"))
	fmt.Printf("  %v %v\n", green("22) "), blue("修改 Xray naiveproxy 端口 (在写了在写了)"))
	fmt.Printf("  %v %v\n", green("23) "), blue("启动 Xray"))
	fmt.Printf("  %v %v\n", green("24) "), blue("重启 Xray"))
	fmt.Printf("  %v %v\n", green("25) "), blue("关闭 Xray"))
	fmt.Printf("  %v %v\n", green("26) "), blue("自启动 Xray"))
	fmt.Printf("  %v %v\n", green("27) "), blue("关闭自启动 Xray"))
	fmt.Printf("  %v %v\n", green("28) "), blue("卸载 Xray"))
	fmt.Printf("  %v %v\n", green("29) "), blue("安装 Xray"))
	fmt.Println()
	fmt.Printf("  %v %v\n", green("0) "), blue("退出此脚本"))
	fmt.Println()
}
